package appmodel.casedetail.orchestration.agreementdetails.dao.customertypefilter;
...
public class CustomerTypeFilterDao extends EntityDao {	
public static final String TABLENAME = "CaseDetail_agreementDetails_AgreementDetails_customerTypeFilter";
...
public static class Properties {
	...
	public final static Property customerTypeFilter = new Property(8,String.class,"customerTypeFilter", false,"customerTypeFilter");
}
public List<appmodel.casedetail.orchestration.agreementdetails.model.customertypefilter.CustomerTypeFilter> executeQuery(long foreignKey) {
	synchronized (this) {
...
List<appmodel.casedetail.orchestration.agreementdetails.model.customertypefilter.CustomerTypeFilter> modelFileObjects = (List<appmodel.casedetail.orchestration.agreementdetails.model.customertypefilter.CustomerTypeFilter>) list;
	return modelFileObjects;
}

public CustomerTypeFilterDao(DaoConfig config)
{
	super(config, TABLENAME);
}

public CustomerTypeFilterDao(DaoConfig config, DaoSession daoSession)
{
